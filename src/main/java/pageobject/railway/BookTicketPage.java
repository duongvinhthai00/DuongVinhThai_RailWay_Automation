...
public class BookTicketPage extends GeneralPage {
    ...
    private Select getComboboxDepartDate() {
        Select comboboxDepartDate = new Select(WebDriverManage.getDriver().findElement(this.comboboxDepartDate));
        return comboboxDepartDate;
    }

    private Select getComboboxDepartFrom() {
        Select comboboxDepartFrom = new Select(WebDriverManage.getDriver().findElement(this.comboboxDepartFrom));
        return comboboxDepartFrom;
    }

    private Select getComboboxArriveAt() {
        Select comboboxArriveAt = new Select(WebDriverManage.getDriver().findElement(this.comboboxArriveAt));
        return comboboxArriveAt;
    }

    private Select getComboboxSeatType() {
        Select comboboxSeatType = new Select(WebDriverManage.getDriver().findElement(this.comboboxSeatType));
        return comboboxSeatType;
    }

    private Select getComboboxTicketAmount() {
        Select comboboxTicketAmount = new Select(WebDriverManage.getDriver().findElement(this.comboboxTicketAmount));
    ...
    public void BookTicket(String DepartDate, String DepartFrom, String ArriveAt, String SeatType, String TicketAmount) {
        ...
        WebDriverManage.ScrollTo(this.getBtnBookTicket());
